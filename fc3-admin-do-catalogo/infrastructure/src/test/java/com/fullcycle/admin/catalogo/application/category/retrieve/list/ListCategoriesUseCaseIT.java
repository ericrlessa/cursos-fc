...
public class ListCategoriesUseCaseIT {
    ...
    void mockup() {
        final var categories = Stream.of(
            ...
            Category.newCategory("Netflix Originals", "Titulos de autoria da Netlix", true), 
    ...
    public void givenAValidSortAndDirection_whenCallsListCategories_thenShouldReturnCategpriesOrdered(
