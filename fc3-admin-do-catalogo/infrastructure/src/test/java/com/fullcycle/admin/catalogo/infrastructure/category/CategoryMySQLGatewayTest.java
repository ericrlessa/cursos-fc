...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsCreate_shouldReturnANewCategory(){
        ...
        final var actualCatetory = categoryGateway.create(aCategory);

        Assertions.assertEquals(aCategory.getId(), actualCatetory.getId());
        ...
        Assertions.assertEquals(aCategory.getCreatedAt(), actualCatetory.getCreatedAt());
        Assertions.assertEquals(aCategory.getUpdatedAt(), actualCatetory.getUpdatedAt());
        Assertions.assertEquals(aCategory.getDeletedAt(), actualCatetory.getDeletedAt());
